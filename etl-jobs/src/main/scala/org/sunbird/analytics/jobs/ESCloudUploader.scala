...
object ESCloudUploader {
    ...
    def main(args: Array[String]): Unit = {
        ...
        val storageService = StorageServiceFactory.getStorageService(StorageConfig(config.getString("cloudStorage.provider"), config.getString("cloudStorage.accountName"), config.getString("cloudStorage.accountKey"),Option.apply(config.getString("cloudStorage.accountEndpoint"))))
