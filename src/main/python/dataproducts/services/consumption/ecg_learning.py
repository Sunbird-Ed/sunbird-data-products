...
def generate_reports(from_time, to_time):
...
def init(data_store_location, is_bootstrap=False):
    start_time_sec = int(round(time.time()))
    write_path = Path(data_store_location).joinpath('ecg_learning_reports')
    ...
    generate_reports(from_time, to_time)
    print("ECG::Completed")
