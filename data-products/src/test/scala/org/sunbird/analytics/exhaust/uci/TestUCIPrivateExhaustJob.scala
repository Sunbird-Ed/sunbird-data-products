...
class TestUCIPrivateExhaustJob extends BaseReportSpec with MockFactory with BaseReportsJob {
  ...
  "UCI Private Exhaust Report" should "generate the report with all the correct data" in {
    ...
    conversationResult.select("Device ID").rdd.map(r => r(0)).collect.toList.head should be("phone:9380991721")
  }
  ...
  "When consent is False" should "Not show the mobile number in the device id column" in {
    ...
    conversationResult.select("Device ID").rdd.map(r => r(0)).collect.toList.head should be("dda0e8a2-0777-4edd-bb36-d1d8970bafa2")
  }
  ...
  def loadUserRegistrationData(): Unit = {
    ...
    EmbeddedPostgresql.execute(s"INSERT INTO $tableName (id, applications_id) VALUES ('4c5abf1b-50d9-4b23-ac9c-1a1489812065', 'fabc64a7-c9b0-4d0b-b8a6-8778757b2bb5');")
    EmbeddedPostgresql.execute(s"INSERT INTO $tableName (id, applications_id) VALUES ('4711abba-d06f-49fb-8c63-c80d0d3df790', '56b31f3d-cc0f-49a1-b559-f7709200aa85');")
    EmbeddedPostgresql.execute(s"INSERT INTO $tableName (id, applications_id) VALUES ('dda0e8a2-0777-4edd-bb36-d1d8970bafa2', '5db54579-04bb-4fb7-a9ee-0f9994cfaada');")
    EmbeddedPostgresql.execute(s"INSERT INTO $tableName (id, applications_id) VALUES ('34ed1146-4eb3-4d3f-8993-b83f62a9aef5', '20b0cdec-a9a6-4bd4-8b36-150d45499946');")
  }
  ...
  def loadBotData(): Unit = {
    ...
    EmbeddedPostgresql.execute(s"INSERT INTO $tableName (id, name, startingMessage, users, logicIDs, owners, created_at, updated_at, status, description, startDate, endDate, purpose,ownerOrgID ) VALUES ('56b31f3d-cc0f-49a1-b559-f7709200aa85', 'Sunbird Bot', 'Hello Sunbird!', NULL, '{}','{}', timestamp '2015-01-11 00:51:14', timestamp '2015-01-11 00:51:14', NULL, NULL, NULL, NULL, NULL);")
    ...
    EmbeddedPostgresql.execute(s"INSERT INTO $tableName (id, name, startingMessage, users, logicIDs, owners, created_at, updated_at, status, description, startDate, endDate, purpose,ownerOrgID ) VALUES ('20b0cdec-a9a6-4bd4-8b36-150d45499946', 'SUNDAY FUN', 'How was sunday', NULL, '{}','{}', timestamp '2015-01-11 00:51:14', timestamp '2015-01-11 00:51:14', NULL, NULL, NULL, NULL, NULL);")
  }
