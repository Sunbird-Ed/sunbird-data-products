...
class TestContentDetailsReport extends SparkSpec with Matchers with MockFactory {
  ...
  it should "execute generate ContentDetails report" in {
    ...
    content("Object Type") should be ("Content")
